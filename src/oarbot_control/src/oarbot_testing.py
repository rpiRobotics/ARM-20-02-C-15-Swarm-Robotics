...
class OarbotControl():
    def __init__(self):
        ...
        self.vel_feedback_name="oarbot_2/vel_feedback"
        self.motor_command_name="oarbot_2/motor_command"
        self.teleop_command_name="spacenav/twist/repub3"
        serial_front = "/dev/serial/by-path/pci-0000:00:14.0-usb-0:3.2:1.0"
        serial_back = "/dev/serial/by-path/pci-0000:00:14.0-usb-0:3.4:1.0"
        ...
        rospy.Timer(rospy.Duration(0.025),self.forward_kin)
