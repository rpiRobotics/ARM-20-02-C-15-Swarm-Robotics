...
class CmdVelTalker():
    def __init__(self):
        ...
        self.cmd_vel_pub_oarbot_blue = rospy.Publisher("/oarbot_blue/cmd_vel", Twist, queue_size=1)
        self.cmd_vel_pub_oarbot_silver = rospy.Publisher("/oarbot_silver/cmd_vel", Twist, queue_size=1)
        self.cmd_vel_pub_husky_blue = rospy.Publisher("/husky_blue/turntable_cmd_vel", Twist, queue_size=1)
        self.cmd_vel_pub_husky_black = rospy.Publisher("/husky_black/turntable_cmd_vel", Twist, queue_size=1)
        self.cmd_vel_pub_ridgeback = rospy.Publisher("/ridgeback/cmd_vel", Twist, queue_size=1)
    ...
    def publish_all_robots(self,msg):
        self.cmd_vel_pub_oarbot_blue.publish(msg)
        self.cmd_vel_pub_oarbot_silver.publish(msg)
        self.cmd_vel_pub_husky_blue.publish(msg)
        self.cmd_vel_pub_husky_black.publish(msg)
        self.cmd_vel_pub_ridgeback.publish(msg)
