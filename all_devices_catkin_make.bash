...
SCRIPTS=(
    "source /opt/ros/noetic/setup.bash; cd; cd catkin_ws;  catkin_make -DCATKIN_WHITELIST_PACKAGES='swarm_msgs;swarm_gui;swarm_launch'"
    ...
    "source /opt/ros/melodic/setup.bash; cd; cd catkin_ws;  catkin_make -DCATKIN_BLACKLIST_PACKAGES='swarm_gui;swarm_control;swarm_launch;oarbot_control'"
    "source /opt/ros/melodic/setup.bash; cd; cd catkin_ws;  catkin_make -DCATKIN_BLACKLIST_PACKAGES='swarm_gui;swarm_control;swarm_launch;oarbot_control'")
for i in ${!HOSTS[*]} ; do
    echo "------------"
    # echo ${HOSTS[i]}
